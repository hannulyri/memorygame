...
import fi.hmp.memorygame.web.filter.CachingHttpHeadersFilter;
import fi.hmp.memorygame.web.filter.StaticResourcesProductionFilter;
import fi.hmp.memorygame.web.filter.gzip.GZipServletFilter;
