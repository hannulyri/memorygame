...
module.exports = function (config) {
    config.set({
        ...
        files: [
            ...
            // endbower
            '../main/webapp/bower_components/angular-isotope/dist/angular-isotope.js',
            '../main/webapp/bower_components/isotope/dist/isotope.pkgd.js',            
            '../main/webapp/scripts/app/app.js',
            '../main/webapp/scripts/app/**/*.js',
            '../main/webapp/scripts/components/**/*.js',
            '../test/javascript/karma/**/!(karma.conf).js'
        ],
