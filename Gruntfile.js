    ...
    grunt.initConfig({
        ...
        wiredep: {
            ...
            karma_test: {
                ...
                exclude: [/angular-i18n/, /swagger-ui/, /angular-scenario/, /isotope/, /angular-isotope/, /outlayer/, /masonry/],
            ...
            dist: {
                files: {
                    src: [
                        ...
                        ['<%= yeoman.dist %>/assets/images/**/*.{png,jpg,jpeg,gif,webp,svg}', '!<%= yeoman.dist %>/assets/images/**/cards/*.{png,jpg,jpeg,gif,webp,svg}'],
